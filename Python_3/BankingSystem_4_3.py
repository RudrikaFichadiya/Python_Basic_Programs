# 12 - October - 2018
# program to implement banking account create and management system
# Using Abstract method, class, object, user defined and predefined functions
from abc import ABCMeta, abstractmethod
from random import randint # random number generation function import
...
while True:
    ...
    if userChoice is 1:
        ...
        if authenticationStatus is True:
            while True:
                print()
                print("Manage Your Account Menu")
